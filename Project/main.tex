...
• Having a detailed policy protects against internal threats and reduces the risk of internal snooping. If an employee tries to open a journal or other documents they do not have a business reason to see, the system will deny access based on the predefined rules in the secure zone.\\ 

• An Integrity Control policy ensures that only authorized personnel can change critical information such as medication dosages and allergies. This is essential for patient safety, as unauthorized changes can be life-threatening to any patient.
